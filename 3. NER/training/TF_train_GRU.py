...
MODEL_NER_CHECKPOINTS = "/media/tensorboard/PRODUCCIÓN Y ACADÉMICO/TRABAJO/D4R_models/NER_models/General_models/roberta-base-bne-Linear-NER/checkpoint-50000"
MODEL_ORIGINAL_CHECKPOINT = 'PlanTL-GOB-ES/roberta-base-bne'
...
OUTPUT_DIRECTORY = f"/home/tensorboard/Documentos/1. D4R/8. Models/TF-GRU-{str(MODEL_SUMMARY_NAME)}-{str(LEARNING_RATE)}-lr-{str(NUM_TRAIN_EPOCHS)}-epochs"
...
new_model.roberta =old_model.roberta # type: ignore
...
new_model.dropout_GRU = new_dropout_GRU # type: ignore
