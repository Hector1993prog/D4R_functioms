...
OUTPUT_DIRECTORY = "/home/tensorboard/Documentos/1. D4R/8. Models/roberta-base-bne-Linear-NER-Religious"
...
OUTPUT_DIRECTORY = f"/home/tensorboard/Documentos/1. D4R/8. Models/Full-LSTM-NER-Religious-{str(MODEL_SUMMARY_NAME)}-{str(LEARNING_RATE)}-lr-{str(NUM_TRAIN_EPOCHS)}-epochs"
...
new_model= RobertaTokenClassifier_With_LSTM.from_pretrained(
                                                            MODEL_CHECKPOINT,
